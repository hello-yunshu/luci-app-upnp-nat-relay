	...
	render: function(data) {
		...
		o.cfgvalue = function() {
			if (env.openclash_installed === 1 || env.openclash_installed === true) {
				return '<span style="color:var(--success-color, #5cb85c)">&#10004; ' + _('Installed') + '</span>';
			}
			return '<span style="color:var(--subtext-color, gray)">&#10008; ' + _('Not Installed') + '</span>';
		};
		...
		o.cfgvalue = function() {
			if (env.openclash_running === 1 || env.openclash_running === true) {
				return '<span style="color:var(--success-color, #5cb85c)">&#10004; ' + _('Running') + '</span>';
			}
			return '<span style="color:var(--warning-color, #f0ad4e)">&#10008; ' + _('Not Running') + '</span>';
		};
		...
		o.cfgvalue = function() {
			if (env.openclash_has_access_control === 1 || env.openclash_has_access_control === true) {
				return '<span style="color:var(--success-color, #5cb85c)">&#10004; ' + _('Detected') + '</span>';
			}
			return '<span style="color:var(--warning-color, #f0ad4e)">&#10008; ' + _('Not Detected') + '</span>';
		};
		...
		o.cfgvalue = function() {
			...
			if (found) {
				return '<span style="color:var(--success-color, #5cb85c)">&#10004; ' + _('Rule exists') + '</span>';
			}
			return '<span style="color:var(--warning-color, #f0ad4e)">&#10008; ' + _('No matching rule found') + '</span>';
		};
		...
		o.rawhtml = true;
		o.cfgvalue = function() {
			return '<span style="color:var(--subtext-color, gray)">' + _('Check via Diagnostics page') + '</span>';
		};
